                ...
                <form id="bookForm" enctype="multipart/form-data">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" id="published_year" name="published_year" min="1900" max="<?php echo date('Y'); ?>" placeholder="Tahun terbit" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" placeholder="Deskripsi lengkap tentang buku" required></textarea>
                    </div>
