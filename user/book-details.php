                        ...
                        <div class="mt-6 space-y-4">
                            ...
                            <?php if (isset($_SESSION['username'])): ?>
                                <?php if ($user_already_borrowed): ?>
                                    <div class="w-full bg-yellow-100 border border-yellow-400 text-yellow-700 py-2 px-4 rounded-md text-center">
                                        Anda sudah meminjam buku ini
                                    </div>
                                    <a href="my-borrowings.php" class="block w-full bg-blue-600 text-white py-2 text-center rounded-md hover:bg-blue-700 transition">
                                        Lihat Riwayat Peminjaman
                                    </a>
                                <?php elseif ($book['available_copies'] > 0): ?>
                                    <a href="borrow-form.php?book_id=<?= $book['id'] ?>" class="block w-full bg-blue-600 text-white py-2 text-center rounded-md hover:bg-blue-700 transition">
                                        Pinjam Buku
                                    </a>
                                <?php else: ?>
                                    <div class="w-full bg-red-100 border border-red-400 text-red-700 py-2 px-4 rounded-md text-center">
                                        Buku tidak tersedia
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="login.php" class="block w-full bg-blue-600 text-white py-2 text-center rounded-md hover:bg-blue-700 transition">
